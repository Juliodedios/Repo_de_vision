...
dronegray=cv2.imread("RGB_p.jpg", 0)#Un solo canal o una sola matriz
#Importamos la imagen del drone en color
dronergb=cv2.imread("RGB_p.jpg", 1) #Tres canales o tres matrices
#Importamos la imagen del drone en color
dronecolor=cv2.imread("RGB_p.jpg") #Tres canales o tres matrices
#Corrección de color
